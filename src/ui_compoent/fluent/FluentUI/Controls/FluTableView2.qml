...
Rectangle {
    ...
    property color selectionColor: FluTheme.primaryColor.lightest
    property color hoverButtonColor: selectionColor
    property color pressedButtonColor: selectionColor
    id:control
...
//            }
            ...
            delegate: Rectangle {
                ...
                Loader{
                    ...
                    anchors.fill: parent
                    sourceComponent: {
                        if(typeof model.itemData == "string")
                        {
                            return com_text
                        }
                        else
    ...
    TableView {
        ...
        implicitWidth: table_view ? table_view.width : 0
    ...
    TableView {
        ...
        implicitHeight: table_view ? table_view.height : 0
