...
public:
    ...
    Q_ENUM(CloseButtonVisibility)
};

class FluNavigationViewType {
    Q_GADGET
public:
    enum DisplayMode {
        Open = 0x0000,
...
public:
    ...
    enum class Fluent_AwesomeType2 {
        GlobalNavButton=0xe700,
        Wifi=0xe701,
        Bluetooth=0xe702,
    };
    Q_ENUM(Fluent_AwesomeType2)
};
