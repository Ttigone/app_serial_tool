...
Item {
    ...
    property int paramScale: 1
    property int paramDecimals: 0
    ...
    Component.onCompleted: {
        ...
        paramScale = param_info['param_scale'];
        paramDecimals = param_info['param_decimals'];

        valueSpinBox.displayText = (paramValue/paramScale).toString();
        valueSpinBox.from = minValue;
        valueSpinBox.to = maxValue;
        valueSpinBox.decimals = paramDecimals;
    ...
    RowLayout{
        ...
        FluDoubleSpinBox {
            ...
            onDisplayTextChanged: {
                ...
                paramValue = text_value*paramScale;
